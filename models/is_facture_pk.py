...
class is_facture_pk(models.Model):
    ...
    matiere_premiere   = fields.Float('Total Matière première (€)'                     , digits=(14, 2), readonly=True, compute='_compute', store=True,tracking=True)
    main_oeuvre        = fields.Float("Total Main d'oeuvre / Prestation de service (€)", digits=(14, 2), readonly=True, compute='_compute', store=True,tracking=True)
