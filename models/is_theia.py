...
class is_raspberry(models.Model):
    ...
    last_presse_id     = fields.Many2one('is.equipement', "Equipement", compute='_compute_presse_id', required=False, readonly=True)
    onglet_indicateurs = fields.Boolean('Onglet Indicateur', default=False)
    onglet_es          = fields.Boolean('Onglet E/S'       , default=False)
    onglet_amr         = fields.Boolean('Onglet AMR'       , default=False)
    onglet_dms         = fields.Boolean('Onglet DMS'       , default=False)
    onglet_ot          = fields.Boolean('Onglet OT'        , default=False)
...
class is_of(models.Model):
    ...
    nb_empreintes     = fields.Integer("Nombre d'empreintes", required=False, tracking=True)
    coef_cpi          = fields.Float("Coefficient Theia", required=False, digits=(14,2), tracking=True)
    ...
    presse_id         = fields.Many2one('is.equipement', u"Equipement",  domain=[('type_id.code','=','PE')], required=False, index=False, tracking=True)
    ...
    ordre             = fields.Integer('Ordre', index=True, required=False, tracking=True)
    qt                = fields.Integer('Qt à produire', required=False)
    qt_reintegree_ci  = fields.Integer('Quantité ré-intégrée (CI)', required=False, tracking=True)
    nb_cycles         = fields.Integer('Nombre de cycles')
    qt_theorique      = fields.Integer('Qt réalisée théorique', required=False, tracking=True)
    qt_declaree       = fields.Integer('Qt déclarée', required=False, tracking=True)
    qt_restante       = fields.Integer('Qt restante', required=False, tracking=True)
    qt_rebut          = fields.Integer('Qt rebuts', tracking=True)
    ...
    cycle_gamme       = fields.Float('Cycle gamme', digits=(12,2), required=False, tracking=True)
    cycle_moyen       = fields.Float('Cycle moyen (10 derniers cycles)', digits=(12,2), required=False)
    cycle_moyen_serie = fields.Float('Cycle moyen', help=u'Temps de production série / nombre de cycles', digits=(12,2), required=False)
    tps_restant       = fields.Float('Temps de production restant', required=False)
    heure_debut       = fields.Datetime('Heure de début de production', index=True, required=False, tracking=True)
    heure_fin         = fields.Datetime('Heure de fin de production', required=False, index=True, tracking=True)
