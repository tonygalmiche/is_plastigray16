...
class is_dossier_article(models.Model):
    ...
    reglementation_tsca  = fields.Selection([('OK', 'OK'),('NOK'  , "NOK")], "Réglementation TSCA", tracking=True) 
    presence_pfas        = fields.Selection([('Oui', 'Oui'),('Non'  , "Non")], "Présence de PFAS" , tracking=True)
    ...
    empreinte_carbonne  = fields.Float('Empreinte Carbone (kg CO2 Eq/kg)', digits=(14,2))
